...
public class SigninCon {
    ...
    //@GetMapping()
//    public List<Rt_sign> findAll() {
//        System.out.println();
//        return this.signinService.findSigninAll();
//    }
    @GetMapping()
    public Msg<Rt_sign> findAllsigninByTypeAndDate(@PathParam("start") String start, @PathParam("end") String end, @PathParam("type") String sign_type) {
    ...
    @PostMapping()
    public void insertSignin(@RequestBody SigninEntity signinEntity) {
